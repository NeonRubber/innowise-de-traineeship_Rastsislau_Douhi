...
Since each folder contains an isolated assignment, please refer to the `README.md` inside specific directories for detailed instructions on how to run the code.
